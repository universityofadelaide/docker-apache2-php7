...
&& apt-get -y install apache2 php7.1-common libapache2-mod-php7.1 mysql-client php-apcu php7.1-curl php7.1-gd php7.1-ldap php7.1-mysql php7.1-opcache php7.1-mbstring php7.1-bcmath php7.1-xml php7.1-zip php7.1-soap libedit-dev php-redis \
